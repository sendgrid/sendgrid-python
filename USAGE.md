...
Default link branding is the actual link brand to be used when sending messages. If there are multiple branded links, the default is determined by the following order:
<ul>
