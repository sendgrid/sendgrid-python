...
The API Keys feature allows customers to generate an API Key credential which can be used for authentication with the SendGrid v3 Web API or the Mail API Endpoint.
...
This endpoint allows you to send email over SendGrids v3 Web API, the most recent version of our API. If you are looking for documentation about the v2 Mail Send endpoint, please see our v2 API Reference.
...
Classroom > How do I add more subusers to my account?
...
How to request more IPs

IPs can be whitelabeled
...
The inbound parse webhook allows you to have incoming emails parsed, extracting some or all of the content, and then have that content POSTed by SendGrid to a URL of your choosing. For more information, please see our User Guide.
...
print response.status_code
print response.body
print response.headersPOST /access_settings/whitelist
