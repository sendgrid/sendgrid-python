...
class ListContactByEmail:
    def __init__(self, client) -> None:
        self.client = client
    
    def send(
        self,
            list_contact_by_email_request: Optional[ListContactByEmailRequest] = None,

    ):
        path='/v3/marketing/contacts/search/emails'

        data = None
        if list_contact_by_email_request:
            data = list_contact_by_email_request.to_dict()
        request = Request(
            method='POST',
            url=path,
            data=data,
