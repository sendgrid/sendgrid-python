...
class ListBatchedContact:
    def __init__(self, client) -> None:
        self.client = client
    
    def send(
        self,
            list_batched_contact_request: Optional[ListBatchedContactRequest] = None,

    ):
        path='/v3/marketing/contacts/batch'

        data = None
        if list_batched_contact_request:
            data = list_batched_contact_request.to_dict()
        request = Request(
            method='POST',
            url=path,
            data=data,
