...
class DeleteAllowedIps:
    ...
    delete_allowed_ips_request: Optional[DeleteAllowedIpsRequest] = None,
        ...
        data = None
        if delete_allowed_ips_request:
            data = delete_allowed_ips_request.to_dict()
        request = Request(
            method='DELETE',
            url=path,
            data=data,
