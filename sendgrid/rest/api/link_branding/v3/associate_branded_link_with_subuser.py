...
class AssociateBrandedLinkWithSubuser:
    ...
    def send(
        self,
        link_id: int,
        associate_branded_link_with_subuser_request: Optional[
            AssociateBrandedLinkWithSubuserRequest
        ] = None,
    ):
        ...
        data = None
        if associate_branded_link_with_subuser_request:
            data = associate_branded_link_with_subuser_request.to_dict()
