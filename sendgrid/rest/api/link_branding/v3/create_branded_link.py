...
class CreateBrandedLink:
    ...
    def send(
        ...
        create_branded_link_request: Optional[CreateBrandedLinkRequest] = None,
    ):
        ...
        data = None
        if create_branded_link_request:
            data = create_branded_link_request.to_dict()
