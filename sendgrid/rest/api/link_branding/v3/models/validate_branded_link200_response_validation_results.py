...
from sendgrid.rest.api.link_branding.v3.models.validate_branded_link200_response_validation_results_domain_cname import (
    ValidateBrandedLink200ResponseValidationResultsDomainCname,
)
from sendgrid.rest.api.link_branding.v3.models.validate_branded_link200_response_validation_results_owner_cname import (
...
class ValidateBrandedLink200ResponseValidationResults:
    def __init__(
        self,
        domain_cname: Optional[
            ValidateBrandedLink200ResponseValidationResultsDomainCname
        ] = None,
        owner_cname: Optional[
            ValidateBrandedLink200ResponseValidationResultsOwnerCname
        ] = None,
    ):
