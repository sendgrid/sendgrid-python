...
from sendgrid.rest.api.link_branding.v3.models.validate_branded_link200_response_validation_results import (
    ValidateBrandedLink200ResponseValidationResults,
)


class ValidateBrandedLink200Response:
    def __init__(
        self,
    ...
    def generate_model(payload: Dict[str, object]):
        return ValidateBrandedLink200Response(
            id=payload.get("id"),
