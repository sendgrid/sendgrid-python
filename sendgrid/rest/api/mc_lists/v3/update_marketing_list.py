...
class UpdateMarketingList:
    ...
    def send(
        self,
            id: str,
    update_marketing_list_request: Optional[UpdateMarketingListRequest] = None,
        ...
        data = None
        if update_marketing_list_request:
            data = update_marketing_list_request.to_dict()
        request = Request(
            method='PATCH',
            url=path,
            data=data,
