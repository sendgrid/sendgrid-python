...
class CreateMarketingList:
    def __init__(self, client) -> None:
        self.client = client

    def send(
        self,
        create_marketing_list_request: Optional[CreateMarketingListRequest] = None,
    ):
        path = "/v3/marketing/lists"

        data = None
        if create_marketing_list_request:
            data = create_marketing_list_request.to_dict()
