...
from sendgrid.rest.api.mail.v3.models.send_mail_request_tracking_settings_click_tracking import (
    SendMailRequestTrackingSettingsClickTracking,
)
from sendgrid.rest.api.mail.v3.models.send_mail_request_tracking_settings_ganalytics import (
    SendMailRequestTrackingSettingsGanalytics,
)
from sendgrid.rest.api.mail.v3.models.send_mail_request_tracking_settings_open_tracking import (
    SendMailRequestTrackingSettingsOpenTracking,
)
from sendgrid.rest.api.mail.v3.models.send_mail_request_tracking_settings_subscription_tracking import (
...
class SendMailRequestTrackingSettings:
    def __init__(
        ...
        subscription_tracking: Optional[
            SendMailRequestTrackingSettingsSubscriptionTracking
        ] = None,
