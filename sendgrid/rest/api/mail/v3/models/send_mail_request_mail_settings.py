...
from sendgrid.rest.api.mail.v3.models.send_mail_request_mail_settings_bypass_bounce_management import (
    SendMailRequestMailSettingsBypassBounceManagement,
)
from sendgrid.rest.api.mail.v3.models.send_mail_request_mail_settings_bypass_list_management import (
    SendMailRequestMailSettingsBypassListManagement,
)
from sendgrid.rest.api.mail.v3.models.send_mail_request_mail_settings_bypass_spam_management import (
    SendMailRequestMailSettingsBypassSpamManagement,
)
from sendgrid.rest.api.mail.v3.models.send_mail_request_mail_settings_bypass_unsubscribe_management import (
    SendMailRequestMailSettingsBypassUnsubscribeManagement,
)
from sendgrid.rest.api.mail.v3.models.send_mail_request_mail_settings_footer import (
    SendMailRequestMailSettingsFooter,
)
from sendgrid.rest.api.mail.v3.models.send_mail_request_mail_settings_sandbox_mode import (
...
class SendMailRequestMailSettings:
    def __init__(
        self,
        bypass_list_management: Optional[
            SendMailRequestMailSettingsBypassListManagement
        ] = None,
        bypass_spam_management: Optional[
            SendMailRequestMailSettingsBypassSpamManagement
        ] = None,
        bypass_bounce_management: Optional[
            SendMailRequestMailSettingsBypassBounceManagement
        ] = None,
        bypass_unsubscribe_management: Optional[
            SendMailRequestMailSettingsBypassUnsubscribeManagement
        ] = None,
