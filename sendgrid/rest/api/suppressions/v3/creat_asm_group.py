...
class CreatAsmGroup:
    ...
    suppression_group_request_base_props: Optional[SuppressionGroupRequestBaseProps] = None,
        ...
        data = None
        if suppression_group_request_base_props:
            data = suppression_group_request_base_props.to_dict()
        request = Request(
            method='POST',
            url=path,
            data=data,
