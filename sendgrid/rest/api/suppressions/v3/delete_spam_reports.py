...
class DeleteSpamReports:
    ...
    delete_spam_reports_request: Optional[DeleteSpamReportsRequest] = None,
        ...
        data = None
        if delete_spam_reports_request:
            data = delete_spam_reports_request.to_dict()
        request = Request(
            method='DELETE',
            url=path,
            data=data,
