...
class DeleteSuppressionBounces:
    ...
    delete_suppression_bounces_request: Optional[DeleteSuppressionBouncesRequest] = None,
        ...
        data = None
        if delete_suppression_bounces_request:
            data = delete_suppression_bounces_request.to_dict()
        request = Request(
            method='DELETE',
            url=path,
            data=data,
