...
class DeleteInvalidEmails:
    ...
    delete_invalid_emails_request: Optional[DeleteInvalidEmailsRequest] = None,
        ...
        data = None
        if delete_invalid_emails_request:
            data = delete_invalid_emails_request.to_dict()
        request = Request(
            method='DELETE',
            url=path,
            data=data,
