...
class DeleteSuppressionBlocks:
    ...
    delete_suppression_blocks_request: Optional[DeleteSuppressionBlocksRequest] = None,
        ...
        data = None
        if delete_suppression_blocks_request:
            data = delete_suppression_blocks_request.to_dict()
        request = Request(
            method='DELETE',
            url=path,
            data=data,
