...
class UpdateScheduledSend:
    ...
    update_scheduled_send_request: Optional[UpdateScheduledSendRequest] = None,
        ...
        data = None
        if update_scheduled_send_request:
            data = update_scheduled_send_request.to_dict()
        request = Request(
            method='PATCH',
            url=path,
            data=data,
