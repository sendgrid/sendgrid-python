...
class CreateScheduledSend:
    ...
    cancel_or_pause_a_scheduled_send_request: Optional[CancelOrPauseAScheduledSendRequest] = None,
        ...
        data = None
        if cancel_or_pause_a_scheduled_send_request:
            data = cancel_or_pause_a_scheduled_send_request.to_dict()
        request = Request(
            method='POST',
            url=path,
            data=data,
