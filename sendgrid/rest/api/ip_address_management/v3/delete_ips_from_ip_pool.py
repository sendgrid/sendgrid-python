...
class DeleteIpsFromIpPool:
    ...
    def send(
        self,
        poolid: str,
        delete_ips_from_ip_pool_request: Optional[DeleteIpsFromIpPoolRequest] = None,
    ):
        ...
        data = None
        if delete_ips_from_ip_pool_request:
            data = delete_ips_from_ip_pool_request.to_dict()
