...
class CreateSender400Response:
    def __init__(
        self, errors: Optional[List[CreateSender400ResponseErrorsInner]] = None
    ):
        self.errors = errors
    ...
    def generate_model(payload: Dict[str, object]):
        return CreateSender400Response(errors=payload.get("errors"))
