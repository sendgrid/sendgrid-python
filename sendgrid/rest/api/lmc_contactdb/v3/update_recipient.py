...
class UpdateRecipient:
    ...
    update_recipient_request_inner: Optional[List[UpdateRecipientRequestInner]] = None,
        ...
        data = None
        if update_recipient_request_inner:
            data = update_recipient_request_inner.to_dict()
        request = Request(
            method='PATCH',
            url=path,
            data=data,
