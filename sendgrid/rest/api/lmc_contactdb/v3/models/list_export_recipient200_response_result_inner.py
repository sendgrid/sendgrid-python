...
class ListExportRecipient200ResponseResultInner:
    def __init__(
            self,
            ...
            segments: Optional[List[ListExportRecipient200ResponseResultInnerSegmentsInner]]=None,
            lists: Optional[List[ListExportRecipient200ResponseResultInnerSegmentsInner]]=None,
            metadata: Optional[ListExportRecipient200ResponseResultInnerMetadata]=None
    ):
        self.id=id
        self.status=status
    ...
    def generate_model(payload: Dict[str, object]):
        return ListExportRecipient200ResponseResultInner(
            id=payload.get('id'),
