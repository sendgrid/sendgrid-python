...
class UpdateForwardBounce:
    ...
    def send(
        ...
        mail_settings_forward_bounce: Optional[MailSettingsForwardBounce] = None,
    ):
        ...
        data = None
        if mail_settings_forward_bounce:
            data = mail_settings_forward_bounce.to_dict()
