...
class UpdateForwardSpam:
    ...
    mail_settings_forward_spam: Optional[MailSettingsForwardSpam] = None,
        ...
        data = None
        if mail_settings_forward_spam:
            data = mail_settings_forward_spam.to_dict()
        request = Request(
            method='PATCH',
            url=path,
            data=data,
