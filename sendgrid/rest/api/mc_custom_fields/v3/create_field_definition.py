...
class CreateFieldDefinition:
    ...
    def send(
        self,
            create_field_definition_request: Optional[CreateFieldDefinitionRequest] = None,

    ):
        path='/v3/marketing/field_definitions'

        data = None
        if create_field_definition_request:
            data = create_field_definition_request.to_dict()
        request = Request(
            method='POST',
            url=path,
            data=data,
