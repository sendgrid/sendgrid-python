...
class UpdateClickTrackingSetting:
    ...
    update_click_tracking_setting_request: Optional[UpdateClickTrackingSettingRequest] = None,
        ...
        data = None
        if update_click_tracking_setting_request:
            data = update_click_tracking_setting_request.to_dict()
        request = Request(
            method='PATCH',
            url=path,
            data=data,
