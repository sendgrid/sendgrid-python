...
class UpdateSubscriptionTrackingSetting:
    ...
    subscription_tracking_settings: Optional[SubscriptionTrackingSettings] = None,
        ...
        data = None
        if subscription_tracking_settings:
            data = subscription_tracking_settings.to_dict()
        request = Request(
            method='PATCH',
            url=path,
            data=data,
