...
from sendgrid.rest.api.ips.v3.models.list_remaining_ip_count200_response_results_inner import (
...
class ListRemainingIpCount200Response:
    ...
    def generate_model(payload: Dict[str, object]):
        return ListRemainingIpCount200Response(results=payload.get("results"))
