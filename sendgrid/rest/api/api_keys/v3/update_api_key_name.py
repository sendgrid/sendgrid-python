...
class UpdateApiKeyName:
    ...
    def send(
        ...
        update_api_key_name_request: Optional[UpdateApiKeyNameRequest] = None,
    ):
        ...
        data = None
        if update_api_key_name_request:
            data = update_api_key_name_request.to_dict()
