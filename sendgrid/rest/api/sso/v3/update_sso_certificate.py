...
class UpdateSsoCertificate:
    ...
    def send(
        self,
            cert_id: str,
    update_sso_certificate_request: Optional[UpdateSsoCertificateRequest] = None,
        ...
        data = None
        if update_sso_certificate_request:
            data = update_sso_certificate_request.to_dict()
        request = Request(
            method='PATCH',
            url=path,
            data=data,
