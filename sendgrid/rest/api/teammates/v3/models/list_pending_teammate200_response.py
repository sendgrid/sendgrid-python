...
class ListPendingTeammate200Response:
    def __init__(
        self, result: Optional[List[ListPendingTeammate200ResponseResultInner]] = None
    ):
        self.result = result
    ...
    def generate_model(payload: Dict[str, object]):
        return ListPendingTeammate200Response(result=payload.get("result"))
