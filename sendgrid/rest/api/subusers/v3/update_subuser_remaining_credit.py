...
class UpdateSubuserRemainingCredit:
    ...
    def send(
        self,
        subuser_name: str,
        update_subuser_remaining_credit_request: Optional[
            UpdateSubuserRemainingCreditRequest
        ] = None,
    ):
        ...
        data = None
        if update_subuser_remaining_credit_request:
            data = update_subuser_remaining_credit_request.to_dict()
