...
class UpdateScheduledCampaign:
    ...
    update_a_scheduled_campaign_request: Optional[UpdateAScheduledCampaignRequest] = None,
        ...
        data = None
        if update_a_scheduled_campaign_request:
            data = update_a_scheduled_campaign_request.to_dict()
        request = Request(
            method='PATCH',
            url=path,
            data=data,
