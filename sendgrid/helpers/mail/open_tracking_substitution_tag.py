class OpenTrackingSubstitutionTag(object):
    ...
    def __init__(self, open_tracking_substitution_tag=None):
        ...
        :param open_tracking_substitution_tag: Allows you to specify a substitution tag 
            that you can insert in the body of your email at a location that you desire. 
            This tag will be replaced by the open tracking pixel.
        """
    ...
    def get(self):
        ...
        :returns: This OpenTrackingSubstitutionTag, ready for use in a request body.
        :rtype: string
        """
