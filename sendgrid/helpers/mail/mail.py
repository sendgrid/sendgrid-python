...
class Mail(object):
    ...
    def _get_internal_personalizations(self, value):
        """Return if it has internal personalizations and internal 
        personalization object

        :param value: Get the object value that could has internal 
        personalization
        :type value: obj
        """
        has_internal_personalization = False
    ...
    def subject(self, value):
        ...
        if isinstance(value, Subject):
            if value.personalization is not None:
                has_internal_personalization, personalization = \
                    self._get_internal_personalizations(value)
    ...
    def add_header(self, header):
        ...
        if header.personalization is not None:
            has_internal_personalization, personalization = \
                self._get_internal_personalizations(header)
    ...
    def add_substitution(self, substitution):
        ...
        if substitution.personalization:
            has_internal_personalization, personalization = \
                self._get_internal_personalizations(substitution)
            personalization.add_substitution(substitution)
    ...
    def add_custom_arg(self, custom_arg):
        ...
        if custom_arg.personalization is not None:
            has_internal_personalization, personalization = \
                self._get_internal_personalizations(custom_arg)
