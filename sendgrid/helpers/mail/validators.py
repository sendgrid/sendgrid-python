...
class ValidateAPIKey(object):
    ...
    def validate_message_dict(self, request_body):
        ...
        Raises:
            APIKeyIncludedException: If any content in request_body
                                     matches regex
        """
    ...
    def validate_message_text(self, message_string):
        """With a message string, check to see if it contains a
        SendGrid API Key If a key is found, throw an exception
