...
class SendGridAPIClient(object):
    ...
    def __init__(
        ...
        :param api_key: SendGrid API key to use. If not provided, key will be
    ...
    def _default_headers(self):
        """Set the default header for a SendGrid v3 API call"""
        headers = {
    ...
    def send(self, message):
        """Make a SendGrid v3 API request with the request body generated by
           the Mail object

        :param message: The SendGrid v3 API request body generated by the Mail
                        object
        :type message: Mail
        """
