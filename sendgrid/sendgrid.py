...
class SendGridAPIClient(object):
    ...
    def send(self, message):
        """Make a SendGrid v3 API request with the request body generated by the Mail object

        :param message: The SendGrid v3 API request body generated by the Mail object
        :type message: Mail
        """
