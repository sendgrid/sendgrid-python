...
from sendgrid.helpers.mail import (
    ASM, Attachment, BCCSettings, BypassListManagement, Category,
    ClickTracking, Content, CustomArg, Email, FooterSettings, Ganalytics,
    Header, Mail, MailSettings, OpenTracking, Personalization, SandBoxMode,
    Section, SpamCheck, SubscriptionTracking, Substitution, TrackingSettings)
...
class UnitTests(unittest.TestCase):
    ...
    def test_kitchenSink(self):
        ...
        attachment.content = "TG9yZW0gaXBzdW0gZG9sb3Igc2l0IGF"
        "tZXQsIGNvbnNlY3RldHVyIGFkaXBpc2NpbmcgZWxpdC4gQ3JhcyBwdW12"
        ...
        tracking_settings.subscription_tracking = SubscriptionTracking(
            ...
            "Optional tag to replace with the open image in the "
            "body of the message"
        )
        tracking_settings.ganalytics = Ganalytics(
            True, "some source", "some medium", "some term", "some content",
            "some campaign")
    ...
    def test_unicode_values_in_substitutions_helper(self):
        ...
        mail.subject = "Testing unicode substitutions "
        "with the SendGrid Python Library"
    ...
    def test_disable_tracking(self):
        ...
        self.assertEqual(tracking_settings.get(), {
            'click_tracking': {
                'enable': False,
                'enable_text': False
            }
