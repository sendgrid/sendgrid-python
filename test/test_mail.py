...
class UnitTests(unittest.TestCase):
    ...
    def test_disable_click_tracking(self):
        tracking_settings = TrackingSettings()
        tracking_settings.set_click_tracking(ClickTracking(False))

        self.assertEqual(json.dumps(tracking_settings.get(), sort_keys=True), '{"click_tracking": {"enable": false}}')
